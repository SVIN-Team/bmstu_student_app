...
type QueueSlot struct {
	...
	QueueID    uuid.UUID       `gorm:"column:queue_id;type:uuid;not null;unique;uniqueIndex:idx_queue_slots_queue_id_student_id;index:idx_slots_queue_timestamp"`
	StudentID  uuid.UUID       `gorm:"column:student_id;type:uuid;not null;unique;uniqueIndex:idx_queue_slots_queue_id_student_id"`
