...
type QueueSlot struct {
	...
	QueueID    uuid.UUID       `gorm:"column:queue_id;type:uuid;not null;uniqueIndex:uq_queue_student;index:idx_slots_queue_timestamp"`
	StudentID  uuid.UUID       `gorm:"column:student_id;type:uuid;not null;uniqueIndex:uq_queue_student"`
